...
@Entity
public class ActivityTrailersSensolus {
    ...
    public ActivityTrailersSensolus() {
    }

    public ActivityTrailersSensolus(Trailer v) {
    ...
    public ActivityTrailersSensolus(String serial, String numberPlate, Date timeStamp, double lat, double lon, String geozone, int accuracy, String address) {
        this.serial = serial;
