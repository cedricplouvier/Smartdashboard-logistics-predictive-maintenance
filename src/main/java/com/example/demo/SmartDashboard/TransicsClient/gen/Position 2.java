...
@XmlSeeAlso({
    NextStopPosition.class,
    PositionResult.class,
    PositionResultV5 .class,
    MapPosition.class,
    MapPositionV2 .class,
    MapPositionV3 .class,
    PositionArea.class,
    GeoPositionResult.class,
    PositionItemResult.class,
    PositionItemResultWithCountryInfo.class,
    PositionItemResultV3 .class,
    PositionItemResultV7 .class,
    NearestPositionItem.class
})
