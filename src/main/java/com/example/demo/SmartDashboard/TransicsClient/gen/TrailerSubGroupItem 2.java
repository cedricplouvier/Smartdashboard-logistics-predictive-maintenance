...
/**
 * <p>Java class for TrailerSubGroupItem complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="TrailerSubGroupItem"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="TrailerList" type="{http://transics.org}ArrayOfTrackedVehicle" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "TrailerSubGroupItem", propOrder = {
    "subGroupCode",
    "subGroupName",
    "trailerList"
})
public class TrailerSubGroupItem {

    @XmlElement(name = "SubGroupCode")
    protected String subGroupCode;
    @XmlElement(name = "SubGroupName")
    protected String subGroupName;
    @XmlElement(name = "TrailerList")
    protected ArrayOfTrackedVehicle trailerList;
    ...
    /**
     * Gets the value of the trailerList property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public ArrayOfTrackedVehicle getTrailerList() {
        return trailerList;
    }

    /**
     * Sets the value of the trailerList property.
     * 
     * @param value
     *     allowed object is
     *     {@link ArrayOfTrackedVehicle }
     *     
     */
    public void setTrailerList(ArrayOfTrackedVehicle value) {
        this.trailerList = value;
    }
