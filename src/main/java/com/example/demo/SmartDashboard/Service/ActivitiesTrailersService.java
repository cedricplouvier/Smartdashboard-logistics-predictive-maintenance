...
import com.example.demo.SmartDashboard.Repository.ActivitiesTrailersRepo;
...
public class ActivitiesTrailersService {
    ...
    @Autowired
    private ActivitiesTrailersRepo activitiesTrailersRepo;

    @Autowired
    private VehicleService vehicleService;

    public List<ActivityTrailers> findAll() {
        return this.activitiesTrailersRepo.findAll();
    }

    public void save(ActivityTrailers activityTrailer){ activitiesTrailersRepo.save(activityTrailer);}
